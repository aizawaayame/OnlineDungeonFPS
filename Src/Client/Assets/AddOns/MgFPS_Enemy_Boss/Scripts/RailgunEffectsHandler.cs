...
using UnityEngine; 
using WeaponController =  Unity.FPS.Game.WeaponController;

namespace Unity.FPS.Addons
{
    [RequireComponent(typeof(Game.WeaponController))]
    public class RailgunEffectsHandler : MonoBehaviour
    {
        ...
        Unity.FPS.Game.WeaponController m_WeaponController;
        ...
        void Start()
        {
            m_WeaponController = GetComponent<Game.WeaponController>();
            DebugUtility.HandleErrorIfNullGetComponent<Game.WeaponController, RailgunEffectsHandler>(m_WeaponController,
                this, gameObject);
