...
namespace GameServer.Services
{
    class UserService : Singleton<UserService>
    {
        ...
        void OnCreateCharacter(NetConnection<NetSession> sender, UserCreateCharacterRequest request)
        {
            ...
            tCharacter.Weapons.Add(weapon);
            DBService.Instance.Entities.Characters.Add(tCharacter);
            sender.Session.TUser.Player.Characters.Add(tCharacter);
            DBService.Instance.Entities.SaveChanges();
            ...
            foreach (var c in sender.Session.TUser.Player.Characters)
            {
                NCharacter info = new NCharacter(){
                    Id = c.ID,
                    ConfigId = c.TID,
                ...
                sender.Session.Response.createChar.nCharacters.Add(info);
        ...
        {
            TCharacter dbchar = sender.Session.TUser.Player.Characters.ElementAt(request.characterIdx);
